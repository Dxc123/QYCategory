#
#  Be sure to run `pod spec lint QYCategory.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "dxc_123"
  # spec.authors            = { "dxc_123" => "daixingchuang@163.com" }
  # spec.social_media_url   = "https://twitter.com/dxc_123"
